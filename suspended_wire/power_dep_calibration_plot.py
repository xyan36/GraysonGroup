...
axs[0].scatter(graph_data.Time, graph_data.X1_ref, label = 'X1_ref')
axs[0].scatter(graph_data.Time, graph_data.Y1_ref, label = 'Y1_ref')
axs[0].set_xlabel('times(s)')
axs[0].set_ylabel('V1w(V)')
axs[0].legend(loc = 'upper left')

axs[1].scatter(graph_data.Time, graph_data.X3, label = 'X3')
axs[1].scatter(graph_data.Time, graph_data.Y3, label = 'Y3')
axs[1].scatter(graph_data.Time, graph_data.X3_ref, label = 'X3_ref')
axs[1].scatter(graph_data.Time, graph_data.Y3_ref, label = 'Y3_ref')
