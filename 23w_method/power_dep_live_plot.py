...
fname = '200416//200416_glass_R56_power_dep_f50.txt'
#x_column = 'B_digital'
#y_column = 'V_real_12'
...
def animate_multi(i, axs, fname, color=None):
    ...
    axs[0].plot(graph_data.Time/60, graph_data.X1, label = 'X1')
    axs[0].plot(graph_data.Time/60, graph_data.Y1, label = 'Y1')
    axs[0].plot(graph_data.Time/60, graph_data.X1_ref, label = 'X1_ref')
    axs[0].plot(graph_data.Time/60, graph_data.Y1_ref, label = 'Y1_ref')
    axs[0].set_xlabel('time(min)')
    axs[0].set_ylabel('V1w(V)')
    axs[0].legend(loc = 'upper right')
    
    axs[1].plot(graph_data.Time/60, graph_data.X3, label = 'X3')
    axs[1].plot(graph_data.Time/60, graph_data.Y3, label = 'Y3')
    axs[1].plot(graph_data.Time/60, graph_data.X3_ref, label = 'X3_ref')
    axs[1].plot(graph_data.Time/60, graph_data.Y3_ref, label = 'Y3_ref')
    ...
    axs[2].plot((graph_data['I1w'])**3, graph_data.X3, label = 'X3')
